...
Default Gatsby 4 boilerplate, but includes [https://github.com/joshwcomeau/dark-mode-minimal](Josh Comeau)'s SSR dark mode. Josh's original implementation but needs an update to work with Gatsby 4.
